...
namespace Otaghche.Infrastructure.Migrations
{
    ...
    [Migration("20250205222816_AddedMoreColumnsToIdentityUser")]
    partial class AddedMoreColumnsToIdentityUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Otaghche.Domain.Entities.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Otaghche.Domain.Entities.ApplicationUser", null)
                        .WithMany()
